      ...
      <Container className="py-12">
        <div className="flex flex-col md:flex-row-reverse justify-between gap-12 text-start">
          ...
          <div className="md:w-1/3">
            ...
            <p className="text-text-muted text-sm mb-6 leading-relaxed">{t('footer.description')}</p>
            ...
            <div className="flex gap-3 justify-start flex-wrap">
              ...
              <a href="https://www.instagram.com/alufcomputers/" target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-card-bg hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#dc2743] flex items-center justify-center transition text-text-muted hover:text-white border border-border-light"
                title="Instagram">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
              ...
              <a href={WA_LINK} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-card-bg hover:bg-[#25D366] flex items-center justify-center transition text-text-muted hover:text-white border border-border-light"
                title="WhatsApp">
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
              ...
              <a href={WAZE_LINK} target="_blank" rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-card-bg hover:bg-[#33CCFF] flex items-center justify-center transition text-text-muted hover:text-white border border-border-light"
                title={t('footer.waze')}>
                <Icon name="navigation" className="text-sm" />
              </a>
              <a href="mailto:sales@aluf.co.il"
                className="w-9 h-9 rounded-full bg-card-bg hover:bg-primary hover:text-white flex items-center justify-center transition text-text-muted border border-border-light"
          ...
          <div className="flex-grow flex flex-col sm:flex-row justify-start gap-10 md:gap-16">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm text-text-muted">
                ...
                <li className="flex items-center gap-3">
                  <Icon name="navigation" className="text-primary text-base flex-shrink-0" />
        ...
        {/* Store map */}
        <div className="mt-10 rounded-xl overflow-hidden border border-border-light">
        ...
        <div className="border-t border-border-light mt-8 pt-8 text-center text-xs text-text-muted">
          {t('footer.copyright')}
        </div>
      </Container>
    </footer>
