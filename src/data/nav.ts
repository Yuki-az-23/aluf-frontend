...
export const mainNavItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { label: 'לוחות אם AMD', href: '/613296-לוחות-אם-AMD/536380' },
  ...
  },
  {
    ...
    href: '/596731-גיימינג',
    subItems: [
      { label: 'מחשבים ניידים גיימינג', href: '/617567-מחשבים-ניידים-גיימינג/536380' },
      { label: 'מחשבים נייחים גיימינג', href: '/617573-מחשבים-נייחים-גיימינג/536380' },
      { label: 'מסכי גיימינג', href: '/617575-מסכי-גיימינג/536380' },
      { label: 'מקלדות גיימינג', href: '/617582-מקלדות-גיימנג/536380' },
      { label: 'עכברי גיימינג', href: '/617588-עכברי-גיימינג/536380' },
